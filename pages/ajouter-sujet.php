...
<form method="post" >
	<div id="wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Ajouter Module</div>
							...
							<div class="row">
						 	<div class="col-lg-10">
										...
										<div class="form-group">
											<div class="col-lg-4">
					 <label>Abréviation<span id="" style="font-size:11px;color:Red">*</span>	</label>
											</div>
		...
		<div class="col-lg-6">
		<input type="text" class="form-control" name="course-full"  id="cfull"required="required" readonly="true">
	...
	<input type="submit" class="btn btn-primary" name="submit" value="Confirmer"></button>
											</div>

...
include('../config/DbFunction.php');
	...
	if(isset($_POST['submit'])){
     ...
     $obj->register($_POST['course-short'],$_POST['c-full'],$_POST['fname'],$_POST['mname'],$_POST['lname'],$_POST['gender'],
     	            $_POST['gname'],$_POST['ocp'],$_POST['income'],$_POST['category'],$_POST['ph'],$_POST['nation']

     	             , $_POST['mobno'],$_POST['email'],$_POST['country'],$_POST['state'],$_POST['city'],$_POST['padd'],
     	              $_POST['cadd'],$_POST['session']);
...
<form method="post" >
	...
	<?php include('leftbar.php');?>
		...
		<div id="page-wrapper">
		    ...
		    <div class="col-lg-4">
			<label>Séléctionner Section<span id="" style="font-size:11px;color:red">*</span>	</label>
			</div>
			<div class="col-lg-6">
...
<option VALUE="">Séléctionner</option>
		...
		<div class="col-lg-6">
 <input class="form-control" name="c-full"  id="c-full" readonly="true">
       </select>
	</div>
	 </div>	
	...
	<br><br>		
			...
			<div class="form-group">
		    <div class="col-lg-2">
			<label>Prénom<span id="" style="font-size:11px;color:red">*</span>	</label>
		...
		<div class="form-group">
		 ...
		 <input type="radio" name="gender" id="female" value="female"> &nbsp; Femme &nbsp;
			</div>
			</div>	
	<br><br>		
		     <div class="form-group">
			...
			<br><br>
		     ...
		     <div class="form-group">
			 <div class="col-lg-2">
			<label>Revenu familial<span id="" style="font-size:11px;color:red">*</span></label>
			
			</div>
			<div class="col-lg-4">
			<input type="number"  class="form-control" name="income"  id="income"required="true" >
...
<option VALUE="">Séléctionner un pays</option>
 ...
 <select name="state" id="state"  class="form-control" onchange="showDist(this.value)" required="required">
	...
	<br><br><br><br>		
        ...
        <option value="">Séléctionner élégation</option>
		</select>
			</div>
			 <div class="col-lg-2">
			<label>Adresse permenante<span id="" style="font-size:11px;color:red">*</span></label>
